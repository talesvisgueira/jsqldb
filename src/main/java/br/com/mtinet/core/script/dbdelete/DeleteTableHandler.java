...
public class DeleteTableHandler extends AbstractHandler  implements Handler  {

	public DeleteTableHandler( Node tagNode,PoolConnection poolConn,ProgressListener listener )  throws Exception{
	...
	public void execute() throws Exception  {
		...
		this.listener.showNewMessage("DELETE "+dsnTarget);
		this.listener.setMax(tot);
		while (tables.next())  {
			sql = "DELETE FROM " +schema+"."+ tables.getString(3);	
